...
, public Variable_stack
{
	...
	void				do_at_debit		(const CString&, const CString&);
	void				do_at_decompile		(const CString&, const CString&);
	void				do_at_describe		(const CString&, const CString&);
	void				do_at_destroy		(const CString&, const CString&);
	void				do_at_dictionary	(const CString&, const CString&);
	void				do_at_dig		(const CString&, const CString&);
	void				do_drop			(const CString&, const CString&);
	void				do_at_dump		(const CString&, const CString&);
	void				do_at_echo		(const CString&, const CString&);
	void				do_at_email		(const CString&, const CString&);
	void				dump_email_addresses		();
	void				do_at_empty		(const CString&, const CString&);
	void				do_enter		(const CString&, const CString&);
	void				do_at_event		(const CString&, const CString&);
	void				do_examine		(const CString&, const CString&);
	void				do_at_fail		(const CString&, const CString&);
	void				do_fchat		(const CString&, const CString&);
	void				do_at_find		(const CString&, const CString&);
	void				do_at_force		(const CString&, const CString&);
	void				do_at_from		(const CString&, const CString&);
	void				do_at_evaluate		(const CString&, const CString&);
	void				do_at_fuse		(const CString&, const CString&);
	void				do_fwho			(const CString&, const CString&);
	void				do_at_garbage_collect	(const CString&, const CString&);
	void				do_get			(const CString&, const CString&);
	void				do_give			(const CString&, const CString&);
	void				do_at_gravity_factor	(const CString&, const CString&);
	...
	void				do_at_link		(const CString&, const CString&);
	void				do_llist		(const CString&, const CString&);
	void				do_at_location		(const CString&, const CString&);
	...
	void				do_at_parent		(const CString&, const CString&);
	void				do_at_peak		(const CString&, const CString&);
	void				do_at_mass		(const CString&, const CString&);
	void				do_at_mass_limit	(const CString&, const CString&);
	void				do_move			(const CString&, const CString&);
	void				do_at_name		(const CString&, const CString&);
	void				do_at_natter		(const CString&, const CString&);
	void				do_at_newpassword	(const CString&, const CString&);
	void				do_at_areanotify	(const CString&, const CString&);
	void				do_notify		(const CString&, const CString&);
	void				do_at_odrop		(const CString&, const CString&);
	void				do_at_ofail		(const CString&, const CString&);
	void				do_open			(const CString&, const CString&);
	void				do_at_osuccess		(const CString&, const CString&);
	void				do_at_owner		(const CString&, const CString&);
	void				do_page			(const CString&, const CString&);
	void				do_at_password		(const CString&, const CString&);
	void				do_at_pcreate		(const CString&, const CString&);
	void				do_at_pemote		(const CString&, const CString&);
	void				do_pose			(const CString&, const CString&);
	void				do_at_property		(const CString&, const CString&);
	void				do_at_puppet		(const CString&, const CString&);
