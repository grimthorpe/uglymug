...
/*TYPE_PLAYER*/
	{FLAG_APPRENTICE, FLAG_ASHCAN, FLAG_BUILDER, 
	 ...
	 FLAG_WELCOMER, FLAG_XBUILDER, FLAG_PRETTYLOOK, 0},

/*TYPE_PUPPET*/
	{FLAG_ASHCAN, FLAG_BUILDER, FLAG_CHOWN_OK, FLAG_CONNECTED, FLAG_FEMALE, FLAG_FIGHTING,
	 FLAG_DEBUG,
